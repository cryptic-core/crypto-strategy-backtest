...
def html(returns, benchmark=None, rf=0., grayscale=False,
    ...
    mddname = _stats.drawdown_details(dd).columns[4]
    dd_info = _stats.drawdown_details(dd).sort_values(
        by=mddname , ascending=True)[:10]
    
    
    dd_info = dd_info[[dd_info.columns[0] ,dd_info.columns[2],dd_info.columns[4],dd_info.columns[3]]]
